...
// The second line contains 𝑛 integer numbers from −1 to 𝑛 − 1 — parents of
// nodes. If the 𝑖-th one of them (0 ≤ 𝑖 ≤ 𝑛 − 1) is −1, node 𝑖 is the root,
...
int tree_height(Node* root) {
  ...
  return 1 +
         *std::max_element(children_heights.begin(), children_heights.end());
}
